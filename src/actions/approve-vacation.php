...
use App\Mail\ApprovedVacationNotification;
...
if ( !empty( $vacation ) ) {
    ...
    if ( $update ) {
        ...
        $responseMessage .= 'Vacation status now is "' . Vacations::STATUS_APPROVED . '".';
        ...
        try {
            ...
            $mail = new ApprovedVacationNotification( $vacation[ Vacations::COLUMN_CREATED ] );
            $mail->send( $userEmail );
        }
        catch ( \Exception $e ) {
